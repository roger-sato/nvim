...
map('n', '<leader>gr', '<cmd>lua require("telescope.builtin").live_grep()<cr>', ns)
...
map('n', '<leader>fr', '<cmd>lua require("telescope.builtin").resume()<cr>', ns)

map('n', 'gr', '<cmd>lua require("telescope.builtin").lsp_references()<cr>', ns)
